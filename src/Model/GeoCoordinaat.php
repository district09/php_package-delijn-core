...
/**
 * GeoCoordinaat Class Doc Comment
 *
 * @category Class
 * @package  District09\DeLijnCoreAPI
 * @author   OpenAPI Generator team
 ...
 */
class GeoCoordinaat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeoCoordinaat';
    ...
    */
     ...
     * Sets latitude
     *
     * @param float|null $latitude bevat de latitude van een geografische locatie
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param float|null $longitude bevat de longitude van een geografische locatie
     *
     * @return self
     */
