...
/**
 * VervoerRegio Class Doc Comment
 *
 * @category Class
 * @package  District09\DeLijnCoreAPI
 * @author   OpenAPI Generator team
 ...
 */
class VervoerRegio implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VervoerRegio';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code vervoerregio code (key waarde)
     *
     * @return self
     */
     ...
     * Sets naam
     *
     * @param string $naam naam vervoerregio
     *
     * @return self
     */
     ...
     * Sets nr
     *
     * @param string $nr nummer vervoerregio voor MDR
     *
     * @return self
     */
    ...
    {
        if (is_null($nr)) {
            throw new \InvalidArgumentException('non-nullable nr cannot be null');
        }
