...
/**
 * LijnLijnrichtingen Class Doc Comment
 *
 * @category Class
 * @package  District09\DeLijnCoreAPI
 * @author   OpenAPI Generator team
 ...
 */
class LijnLijnrichtingen implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LijnLijnrichtingen';
    ...
    protected static $openAPITypes = [
        'lijn' => '\District09\DeLijnCoreAPI\Model\Lijn',
    ...
    {
        $this->setIfExists('lijn', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lijn'] === null) {
            $invalidProperties[] = "'lijn' can't be null";
        }
        if ($this->container['lijnrichtingen'] === null) {
            $invalidProperties[] = "'lijnrichtingen' can't be null";
        }
    ...
    {
        return $this->container['lijn'];
    }

    /**
     * Sets lijn
     *
     * @param \District09\DeLijnCoreAPI\Model\Lijn $lijn lijn
     *
     * @return self
     */
    public function setLijn($lijn)
    {
        if (is_null($lijn)) {
            throw new \InvalidArgumentException('non-nullable lijn cannot be null');
        }
        $this->container['lijn'] = $lijn;
     ...
     * Sets lijnrichtingen
     *
     * @param \District09\DeLijnCoreAPI\Model\Lijnrichting[] $lijnrichtingen Geeft de lijnrichting(en) van de lijn sleutel
     *
     * @return self
     */
