 ...
 */
class Punt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Punt';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id bevat de identificatie van een locatie bv. haltenummer van een stop van De Lijn
     *
     * @return self
     */
     ...
     * Sets naam
     *
     * @param string|null $naam bevat de naam of omschrijving van een locatie
     *
     * @return self
     */
     ...
     * Sets afstand
     *
     * @param int|null $afstand bevat de afstand in meters tot de opgegeven coordinaat
     *
     * @return self
     */
