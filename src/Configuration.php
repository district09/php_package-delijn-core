...
namespace District09\DeLijnCoreAPI;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.delijn.be/DLKernOpenData/api/v1';
    ...
    {
        $report  = 'PHP SDK (District09\DeLijnCoreAPI) Debug Report:' . PHP_EOL;
